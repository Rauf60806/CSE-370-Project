...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql_inventory)) {
        ...
        addLog($conn, $user_name, $log_message);
        // --- AUTOMATIC LOG END ---
        ...
        echo "<p style='color:red;'>Error adding inventory: " . mysqli_error($conn) . "</p>";
    }
}

if (isset($_GET['success'])) {
    echo "<h2 style='color:#4CAF50;'>Inventory added successfully</h2>";
}
...
?>
    ...
    <button onclick="window.location.href='showinventory.php'">
        Show Inventory
    </button>
</form>
</div>
