...
<form method="post" style="margin: 0 auto; max-width: 500px; font-weight: bold; text-shadow: 1px 1px 2px white;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <select name="Category" required style="width: 100%; padding: 8px; border-radius: 5px;">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="number" name="price" required style="width: 100%; padding: 8px; border-radius: 5px;">
    </div>

    <div style="margin-bottom: 20px;">
        <label style="font-weight: bold;">Add Quantity</label><br>
        <input type="number" name="quantity" required style="width: 100%; padding: 8px; border-radius: 5px;">
    </div>
